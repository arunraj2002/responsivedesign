...
<head>
    ...
    <title>AR Industries Limited</title>
</head>

<body>
    <div class="jumbotron">
        <div class="container text-center">
            <h1 class="display-3">AR Industries Limited</h1>
    ...
    <div class="container">
        <div class="row align-items-end">
            <div class="col text-center">
                Copyright © 2021 AR Industries Limited, Developed by ARUN RAJ
            </div>
        </div>
    </div>
    <!-- Optional JavaScript -->
...
<div class="row text-center">
    ...
    <img class="card-img-top" src="/static/img/i1.png" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/i2.png" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/i3.png" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/i4.png" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/i8.png" alt="Card image cap">
    <div class="card-body">
...
{% block content %}
    <div class="jumbotron">
        <div class="container text-center">
            <h1 class="display-3">AR Private Limited</h1>
    ...
    <div class="row text-center">
        <div class="card col-12 col-md-6 col-lg-3">
            <img class="card-img-top" src="/static/img/c.jpg" alt="card image cap">
            <div class="card-body">
        ...
        <div class="card col-12 col-md-6 col-lg-3">
            ...
            <div class="card-body">
                <h5 class="card-title">AAKAASH</h5>
        ...
        <div class="card col-12 col-md-6 col-lg-3">
            ...
            <div class="card-body">
                <h5 class="card-title">CHETAN DINESH</h5>
        ...
        <div class="card col-12 col-md-6 col-lg-3">
            ...
            <div class="card-body">
                <h5 class="card-title">SURYA PRASANNA</h5>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <p class="card-text">
            <hr>
        <div class="col text-center">
            <h4 class="lead">Email: arcompany@gmail.com</h4><br>
            <h4 class="lead">Phone: +1-1594227</h4><br>
            <h4 class="lead">Address: © AR Industries Limited,Mountain View, California, United-States</h4>
        </div>
        <hr>
    </div>
</div>
...
![output](./static/img/H1.jpg)
![output](./static/img/H2.jpg)
![output](./static/img/b1.png)
![output](./static/img/b2.png)
![output](./static/img/b3.png)
![output](./static/img/b4.png)
![output](./static/img/b5.png)
![output](./static/img/b6.png)
![output](./static/img/b7.png)
![output](./static/img/b8.png)
![output](./static/img/b9.png)
...
http://arun.student.saveetha.in:8000/